...
function processLaser(laser)
    ...
    object, laser.endPoint = castRay(newVec(laser.x, laser.y), newVec(laser.x, 600), items, laserGetPos, laserGetRadius)
...
function drawLaser(laser)
    ...
    if laser.activeTimer < 0 then
        ...
        love.graphics.rectangle("fill", laser.x - width * 0.5, laser.y, width, laser.endPoint.y - laser.y, width * 0.5, width * 0.5)
